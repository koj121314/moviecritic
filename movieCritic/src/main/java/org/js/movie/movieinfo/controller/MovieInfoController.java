...
public class MovieInfoController {
	...
	@RequestMapping(value = "/movie_list.searchByGenre", method = RequestMethod.GET) 
	public void getGenreSearchList(@RequestParam("genre") String genre, Model model) {
		
		log.info("##  검색리퀘스트##");
		List<MovieInfoVO> list = null;
		list =  movieInfoService.searchByGenre(genre);
