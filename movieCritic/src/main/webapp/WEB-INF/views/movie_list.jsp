...
// 				}
				...
				function getSearchResult(id){
					var id = id.replace("Select", "Search");
			...
			<div id="select1">
				...
				<form id = "genreSearch" action="${rootPath}/movie_list.searchByGenre" method="get">
					<select name="genre" id = "genreSelect" class="search_select" onchange="getSearchResult(this.id)">
			...
			<div id="select2">
				...
				<select name="timeframe" id="timeframe" class="search_select">
				...
				<%-- <c:forEach items="${list}" var="list" varStatus="status">
				 <%-- items 에는 속성명을 적어줌 					<tr>
						...
						<td><fmt:formatDate value="${list.releaseDate}" pattern="yyyy.MM.dd"/></td>
							...
							<c:forEach items="${list}" var="list" varStatus="status">
<!-- 							 items 에는 속성명을 적어줌  (varStatus로 처리하는 법) -->
							<tr>
